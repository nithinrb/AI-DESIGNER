...
const Register = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-secondary rounded-full mix-blend-multiply filter blur-[128px] opacity-20"></div>
      ...
      >
        <div className="glass-dark p-8 rounded-2xl shadow-2xl border border-white/10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Join to start designing your space</p>
          </div>
